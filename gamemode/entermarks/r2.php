...
<section>
  ...
  <div class="tbl-content">
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
        <input type="text" name="round" value="r2" hidden>
        ...
        // Prepare the SQL statement to select the user with the given username and password
           $stmt = $conn->prepare("SELECT * FROM registration WHERE Status = 'ONGAME' AND Next = 'r2' ORDER BY TeamID  ");
